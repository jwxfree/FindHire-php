...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            <div class="container">
                <a class="navbar-brand" href="/"><span data-feather="briefcase"></span>  FindHire</a>
    ...
    <li class="nav-item dropdown ">
        ...
        <ul class="dropdown-menu">
            ...
            {{-- New Chat Applications Link --}}
            <li><a class="dropdown-item" href="/my-chats">
                <span data-feather="message-square"></span> My Chats
            </a></li>

            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('messages.inbox') }}">Inbox ({{ $unreadMessages }})</a>
                        </li>
                        @guest
                            <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                {{ auth()->user()->name }} 
                                <i class="ms-1" style="width:20px; height:20px" data-feather="user"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/profile">Profile</a></li>
                                <li><a class="dropdown-item" href="{{ route('messages.inbox') }}">Inbox ({{ $unreadMessages }})</a></li>
                        ...
                        <li>
                            <a href="/register" class="rounded-0 btn btn-light text-success">Register</a>
                        </li>
                        @endauth
                    </ul>
                </div>
            ...
            <div class="carousel-inner bg-dark">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block my-lg-5">
                        ...
                        <p>Recruitee is the top job site in the world with unique visitors every month. We connect millions of people to new opportunities every day.</p>

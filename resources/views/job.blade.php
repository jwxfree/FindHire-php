...
@section('container')
    <a href="/jobs" class="btn btn-success my-3"><i data-feather="chevron-left"></i> Back</a>
    <div class="row justify-content-center">
        <article class="border shadow col-md-8 p-3 mb-5">
            ...
            <button data-bs-toggle="modal" data-bs-target="#modal" class="mb-3 btn btn-success">Apply Job</button>
